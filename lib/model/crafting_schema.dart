...
class CraftingSchema {
    ...
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'code'),
            'Required key "CraftingSchema[code]" is missing from JSON.');
        assert(json[r'code'] != null,
            'Required key "CraftingSchema[code]" has a null value in JSON.');
        return true;
      }());
  ...
  static List<CraftingSchema> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<CraftingSchema>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = CraftingSchema.listFromJson(
          entry.value,
          growable: growable,
        );
      }
