    ...
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'current_password'),
            'Required key "ChangePasswordSchema[current_password]" is missing from JSON.');
        assert(json[r'current_password'] != null,
            'Required key "ChangePasswordSchema[current_password]" has a null value in JSON.');
        assert(json.containsKey(r'new_password'),
            'Required key "ChangePasswordSchema[new_password]" is missing from JSON.');
        assert(json[r'new_password'] != null,
            'Required key "ChangePasswordSchema[new_password]" has a null value in JSON.');
        return true;
      }());
