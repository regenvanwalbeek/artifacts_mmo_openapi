...
class DataPageGEOrderSchema {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is DataPageGEOrderSchema &&
  ...
  @override
  String toString() => 'DataPageGEOrderSchema[data=$data, total=$total, page=$page, size=$size, pages=$pages]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "DataPageGEOrderSchema[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "DataPageGEOrderSchema[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<DataPageGEOrderSchema> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<DataPageGEOrderSchema>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<DataPageGEOrderSchema>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = DataPageGEOrderSchema.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
