    ...
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'data'),
            'Required key "DataPageGEOrderSchema[data]" is missing from JSON.');
        assert(json[r'data'] != null,
            'Required key "DataPageGEOrderSchema[data]" has a null value in JSON.');
        assert(json.containsKey(r'total'),
            'Required key "DataPageGEOrderSchema[total]" is missing from JSON.');
        assert(json[r'total'] != null,
            'Required key "DataPageGEOrderSchema[total]" has a null value in JSON.');
        assert(json.containsKey(r'page'),
            'Required key "DataPageGEOrderSchema[page]" is missing from JSON.');
        assert(json[r'page'] != null,
            'Required key "DataPageGEOrderSchema[page]" has a null value in JSON.');
        assert(json.containsKey(r'size'),
            'Required key "DataPageGEOrderSchema[size]" is missing from JSON.');
        assert(json[r'size'] != null,
            'Required key "DataPageGEOrderSchema[size]" has a null value in JSON.');
        assert(json.containsKey(r'pages'),
            'Required key "DataPageGEOrderSchema[pages]" is missing from JSON.');
        assert(json[r'pages'] != null,
            'Required key "DataPageGEOrderSchema[pages]" has a null value in JSON.');
        return true;
      }());
