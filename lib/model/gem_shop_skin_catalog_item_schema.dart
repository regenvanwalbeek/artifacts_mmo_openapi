    ...
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'code'),
            'Required key "GemShopSkinCatalogItemSchema[code]" is missing from JSON.');
        assert(json[r'code'] != null,
            'Required key "GemShopSkinCatalogItemSchema[code]" has a null value in JSON.');
        assert(json.containsKey(r'name'),
            'Required key "GemShopSkinCatalogItemSchema[name]" is missing from JSON.');
        assert(json[r'name'] != null,
            'Required key "GemShopSkinCatalogItemSchema[name]" has a null value in JSON.');
        assert(json.containsKey(r'description'),
            'Required key "GemShopSkinCatalogItemSchema[description]" is missing from JSON.');
        assert(json[r'description'] != null,
            'Required key "GemShopSkinCatalogItemSchema[description]" has a null value in JSON.');
        assert(json.containsKey(r'price'),
            'Required key "GemShopSkinCatalogItemSchema[price]" is missing from JSON.');
        assert(json[r'price'] != null,
            'Required key "GemShopSkinCatalogItemSchema[price]" has a null value in JSON.');
        return true;
      }());
