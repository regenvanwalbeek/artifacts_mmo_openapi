      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "GemShopSubscriptionCatalogItemSchema[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "GemShopSubscriptionCatalogItemSchema[$key]" has a null value in JSON.');
        });
        return true;
      }());
