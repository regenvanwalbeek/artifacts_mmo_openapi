    ...
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'data'),
            'Required key "StaticDataPageEffectSchema[data]" is missing from JSON.');
        assert(json[r'data'] != null,
            'Required key "StaticDataPageEffectSchema[data]" has a null value in JSON.');
        assert(json.containsKey(r'total'),
            'Required key "StaticDataPageEffectSchema[total]" is missing from JSON.');
        assert(json[r'total'] != null,
            'Required key "StaticDataPageEffectSchema[total]" has a null value in JSON.');
        assert(json.containsKey(r'page'),
            'Required key "StaticDataPageEffectSchema[page]" is missing from JSON.');
        assert(json[r'page'] != null,
            'Required key "StaticDataPageEffectSchema[page]" has a null value in JSON.');
        assert(json.containsKey(r'size'),
            'Required key "StaticDataPageEffectSchema[size]" is missing from JSON.');
        assert(json[r'size'] != null,
            'Required key "StaticDataPageEffectSchema[size]" has a null value in JSON.');
        assert(json.containsKey(r'pages'),
            'Required key "StaticDataPageEffectSchema[pages]" is missing from JSON.');
        assert(json[r'pages'] != null,
            'Required key "StaticDataPageEffectSchema[pages]" has a null value in JSON.');
        return true;
      }());
