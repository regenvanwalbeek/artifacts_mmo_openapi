...
class GECreateOrderTransactionResponseSchema {
  /// Returns a new [GECreateOrderTransactionResponseSchema] instance.
  ...
  /// Returns a new [GECreateOrderTransactionResponseSchema] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static GECreateOrderTransactionResponseSchema? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'data'),
            'Required key "GECreateOrderTransactionResponseSchema[data]" is missing from JSON.');
        assert(json[r'data'] != null,
            'Required key "GECreateOrderTransactionResponseSchema[data]" has a null value in JSON.');
        return true;
      }());

      return GECreateOrderTransactionResponseSchema(
        data: GEOrderTransactionSchema.fromJson(json[r'data'])!,
      );
    }
    return null;
  }
  ...
  static List<GECreateOrderTransactionResponseSchema> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = GECreateOrderTransactionResponseSchema.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
