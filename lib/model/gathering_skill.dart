...
class GatheringSkill {
  ...
  static const mining = GatheringSkill._(r'mining');
  static const woodcutting = GatheringSkill._(r'woodcutting');
  static const fishing = GatheringSkill._(r'fishing');
  static const alchemy = GatheringSkill._(r'alchemy');

  /// List of all possible values in this [enum][GatheringSkill].
  static const values = <GatheringSkill>[
    mining,
    woodcutting,
    fishing,
    alchemy,
  ...
  static List<GatheringSkill> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = GatheringSkill.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
class GatheringSkillTypeTransformer {
  ...
  String encode(GatheringSkill data) => data.value;

  /// Decodes a [dynamic value][data] to a GatheringSkill.
  ///
