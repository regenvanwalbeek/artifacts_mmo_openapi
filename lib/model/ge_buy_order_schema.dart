...
class GEBuyOrderSchema {
  ...
  /// Returns a new [GEBuyOrderSchema] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static GEBuyOrderSchema? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<GEBuyOrderSchema> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = GEBuyOrderSchema.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, GEBuyOrderSchema> mapFromJson(dynamic json) {
    final map = <String, GEBuyOrderSchema>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = GEBuyOrderSchema.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
