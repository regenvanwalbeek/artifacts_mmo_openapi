    ...
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'data'),
            'Required key "StaticDataPageAchievementSchema[data]" is missing from JSON.');
        assert(json[r'data'] != null,
            'Required key "StaticDataPageAchievementSchema[data]" has a null value in JSON.');
        assert(json.containsKey(r'total'),
            'Required key "StaticDataPageAchievementSchema[total]" is missing from JSON.');
        assert(json[r'total'] != null,
            'Required key "StaticDataPageAchievementSchema[total]" has a null value in JSON.');
        assert(json.containsKey(r'page'),
            'Required key "StaticDataPageAchievementSchema[page]" is missing from JSON.');
        assert(json[r'page'] != null,
            'Required key "StaticDataPageAchievementSchema[page]" has a null value in JSON.');
        assert(json.containsKey(r'size'),
            'Required key "StaticDataPageAchievementSchema[size]" is missing from JSON.');
        assert(json[r'size'] != null,
            'Required key "StaticDataPageAchievementSchema[size]" has a null value in JSON.');
        assert(json.containsKey(r'pages'),
            'Required key "StaticDataPageAchievementSchema[pages]" is missing from JSON.');
        assert(json[r'pages'] != null,
            'Required key "StaticDataPageAchievementSchema[pages]" has a null value in JSON.');
        return true;
      }());
