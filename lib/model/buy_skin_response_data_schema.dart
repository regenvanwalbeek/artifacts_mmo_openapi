    ...
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'skins'),
            'Required key "BuySkinResponseDataSchema[skins]" is missing from JSON.');
        assert(json[r'skins'] != null,
            'Required key "BuySkinResponseDataSchema[skins]" has a null value in JSON.');
        assert(json.containsKey(r'skin'),
            'Required key "BuySkinResponseDataSchema[skin]" is missing from JSON.');
        assert(json[r'skin'] != null,
            'Required key "BuySkinResponseDataSchema[skin]" has a null value in JSON.');
        assert(json.containsKey(r'gems'),
            'Required key "BuySkinResponseDataSchema[gems]" is missing from JSON.');
        assert(json[r'gems'] != null,
            'Required key "BuySkinResponseDataSchema[gems]" has a null value in JSON.');
        return true;
      }());
