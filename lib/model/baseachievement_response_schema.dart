...
class BaseachievementResponseSchema {
  /// Returns a new [BaseachievementResponseSchema] instance.
  ...
  /// Returns a new [BaseachievementResponseSchema] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static BaseachievementResponseSchema? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return BaseachievementResponseSchema(
        data: BaseAchievementSchema.fromJson(json[r'data'])!,
      );
    }
    return null;
  }
  ...
  static List<BaseachievementResponseSchema> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = BaseachievementResponseSchema.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, BaseachievementResponseSchema> mapFromJson(dynamic json) {
    final map = <String, BaseachievementResponseSchema>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = BaseachievementResponseSchema.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
