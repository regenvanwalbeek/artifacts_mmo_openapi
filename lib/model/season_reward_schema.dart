    ...
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'code'),
            'Required key "SeasonRewardSchema[code]" is missing from JSON.');
        assert(json[r'code'] != null,
            'Required key "SeasonRewardSchema[code]" has a null value in JSON.');
        assert(json.containsKey(r'type'),
            'Required key "SeasonRewardSchema[type]" is missing from JSON.');
        assert(json[r'type'] != null,
            'Required key "SeasonRewardSchema[type]" has a null value in JSON.');
        assert(json.containsKey(r'description'),
            'Required key "SeasonRewardSchema[description]" is missing from JSON.');
        assert(json[r'description'] != null,
            'Required key "SeasonRewardSchema[description]" has a null value in JSON.');
        assert(json.containsKey(r'required_points'),
            'Required key "SeasonRewardSchema[required_points]" is missing from JSON.');
        assert(json[r'required_points'] != null,
            'Required key "SeasonRewardSchema[required_points]" has a null value in JSON.');
        return true;
      }());
