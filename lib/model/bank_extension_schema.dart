...
class BankExtensionSchema {
  ...
  bool operator ==(Object other) =>
      ...
      other is BankExtensionSchema && other.price == price;
    ...
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'price'),
            'Required key "BankExtensionSchema[price]" is missing from JSON.');
        assert(json[r'price'] != null,
            'Required key "BankExtensionSchema[price]" has a null value in JSON.');
        return true;
      }());
  ...
  static List<BankExtensionSchema> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<BankExtensionSchema>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = BankExtensionSchema.listFromJson(
          entry.value,
          growable: growable,
        );
      }
