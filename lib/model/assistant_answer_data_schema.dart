    ...
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'answer'),
            'Required key "AssistantAnswerDataSchema[answer]" is missing from JSON.');
        assert(json[r'answer'] != null,
            'Required key "AssistantAnswerDataSchema[answer]" has a null value in JSON.');
        assert(json.containsKey(r'assistant'),
            'Required key "AssistantAnswerDataSchema[assistant]" is missing from JSON.');
        assert(json[r'assistant'] != null,
            'Required key "AssistantAnswerDataSchema[assistant]" has a null value in JSON.');
        assert(json.containsKey(r'paid_with_gems'),
            'Required key "AssistantAnswerDataSchema[paid_with_gems]" is missing from JSON.');
        assert(json[r'paid_with_gems'] != null,
            'Required key "AssistantAnswerDataSchema[paid_with_gems]" has a null value in JSON.');
        return true;
      }());
