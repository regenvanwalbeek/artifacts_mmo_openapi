      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "GemShopCustomDesignCatalogItemSchema[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "GemShopCustomDesignCatalogItemSchema[$key]" has a null value in JSON.');
        });
        return true;
      }());
