    ...
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'code'),
            'Required key "RewardItemSchema[code]" is missing from JSON.');
        assert(json[r'code'] != null,
            'Required key "RewardItemSchema[code]" has a null value in JSON.');
        assert(json.containsKey(r'quantity'),
            'Required key "RewardItemSchema[quantity]" is missing from JSON.');
        assert(json[r'quantity'] != null,
            'Required key "RewardItemSchema[quantity]" has a null value in JSON.');
        return true;
      }());
