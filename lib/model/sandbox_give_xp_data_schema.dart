    ...
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'cooldown'),
            'Required key "SandboxGiveXPDataSchema[cooldown]" is missing from JSON.');
        assert(json[r'cooldown'] != null,
            'Required key "SandboxGiveXPDataSchema[cooldown]" has a null value in JSON.');
        assert(json.containsKey(r'type'),
            'Required key "SandboxGiveXPDataSchema[type]" is missing from JSON.');
        assert(json[r'type'] != null,
            'Required key "SandboxGiveXPDataSchema[type]" has a null value in JSON.');
        assert(json.containsKey(r'amount'),
            'Required key "SandboxGiveXPDataSchema[amount]" is missing from JSON.');
        assert(json[r'amount'] != null,
            'Required key "SandboxGiveXPDataSchema[amount]" has a null value in JSON.');
        assert(json.containsKey(r'character'),
            'Required key "SandboxGiveXPDataSchema[character]" is missing from JSON.');
        assert(json[r'character'] != null,
            'Required key "SandboxGiveXPDataSchema[character]" has a null value in JSON.');
        return true;
      }());
