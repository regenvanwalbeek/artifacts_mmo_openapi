...
class ChangeEmailSchema {
  ...
  static ChangeEmailSchema? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'current_email'),
            'Required key "ChangeEmailSchema[current_email]" is missing from JSON.');
        assert(json[r'current_email'] != null,
            'Required key "ChangeEmailSchema[current_email]" has a null value in JSON.');
        assert(json.containsKey(r'new_email'),
            'Required key "ChangeEmailSchema[new_email]" is missing from JSON.');
        assert(json[r'new_email'] != null,
            'Required key "ChangeEmailSchema[new_email]" has a null value in JSON.');
        return true;
      }());
