...
class DataPageTaskFullSchema {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is DataPageTaskFullSchema &&
  ...
  @override
  String toString() => 'DataPageTaskFullSchema[data=$data, total=$total, page=$page, size=$size, pages=$pages]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "DataPageTaskFullSchema[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "DataPageTaskFullSchema[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<DataPageTaskFullSchema> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<DataPageTaskFullSchema>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<DataPageTaskFullSchema>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = DataPageTaskFullSchema.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
