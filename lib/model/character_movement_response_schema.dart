...
class CharacterMovementResponseSchema {
  /// Returns a new [CharacterMovementResponseSchema] instance.
  ...
  /// Returns a new [CharacterMovementResponseSchema] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CharacterMovementResponseSchema? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return CharacterMovementResponseSchema(
        data: CharacterMovementDataSchema.fromJson(json[r'data'])!,
      );
    }
    return null;
  }
  ...
  static List<CharacterMovementResponseSchema> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CharacterMovementResponseSchema.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CharacterMovementResponseSchema> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value = CharacterMovementResponseSchema.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
