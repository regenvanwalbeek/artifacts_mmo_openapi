      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "GemShopSubscriptionResponseDataSchema[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "GemShopSubscriptionResponseDataSchema[$key]" has a null value in JSON.');
        });
        return true;
      }());
