...
class DataPageItemSchema {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is DataPageItemSchema &&
  ...
  @override
  String toString() => 'DataPageItemSchema[data=$data, total=$total, page=$page, size=$size, pages=$pages]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "DataPageItemSchema[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "DataPageItemSchema[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<DataPageItemSchema> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<DataPageItemSchema>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<DataPageItemSchema>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = DataPageItemSchema.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
