    ...
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'cooldown'),
            'Required key "TaskCancelledSchema[cooldown]" is missing from JSON.');
        assert(json[r'cooldown'] != null,
            'Required key "TaskCancelledSchema[cooldown]" has a null value in JSON.');
        assert(json.containsKey(r'character'),
            'Required key "TaskCancelledSchema[character]" is missing from JSON.');
        assert(json[r'character'] != null,
            'Required key "TaskCancelledSchema[character]" has a null value in JSON.');
        return true;
      }());
