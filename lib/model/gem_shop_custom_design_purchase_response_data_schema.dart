      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "GemShopCustomDesignPurchaseResponseDataSchema[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "GemShopCustomDesignPurchaseResponseDataSchema[$key]" has a null value in JSON.');
        });
        return true;
      }());
