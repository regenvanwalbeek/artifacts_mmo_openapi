...
class TasksRewardDataResponseSchema {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TasksRewardDataResponseSchema &&
    other.data == data;
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TasksRewardDataResponseSchema[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TasksRewardDataResponseSchema[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<TasksRewardDataResponseSchema> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<TasksRewardDataResponseSchema>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TasksRewardDataResponseSchema>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = TasksRewardDataResponseSchema.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
