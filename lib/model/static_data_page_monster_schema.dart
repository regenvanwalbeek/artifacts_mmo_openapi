    ...
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'data'),
            'Required key "StaticDataPageMonsterSchema[data]" is missing from JSON.');
        assert(json[r'data'] != null,
            'Required key "StaticDataPageMonsterSchema[data]" has a null value in JSON.');
        assert(json.containsKey(r'total'),
            'Required key "StaticDataPageMonsterSchema[total]" is missing from JSON.');
        assert(json[r'total'] != null,
            'Required key "StaticDataPageMonsterSchema[total]" has a null value in JSON.');
        assert(json.containsKey(r'page'),
            'Required key "StaticDataPageMonsterSchema[page]" is missing from JSON.');
        assert(json[r'page'] != null,
            'Required key "StaticDataPageMonsterSchema[page]" has a null value in JSON.');
        assert(json.containsKey(r'size'),
            'Required key "StaticDataPageMonsterSchema[size]" is missing from JSON.');
        assert(json[r'size'] != null,
            'Required key "StaticDataPageMonsterSchema[size]" has a null value in JSON.');
        assert(json.containsKey(r'pages'),
            'Required key "StaticDataPageMonsterSchema[pages]" is missing from JSON.');
        assert(json[r'pages'] != null,
            'Required key "StaticDataPageMonsterSchema[pages]" has a null value in JSON.');
        return true;
      }());
