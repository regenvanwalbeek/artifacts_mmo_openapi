...
class DepositWithdrawGoldSchema {
  /// Returns a new [DepositWithdrawGoldSchema] instance.
  ...
  /// Returns a new [DepositWithdrawGoldSchema] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static DepositWithdrawGoldSchema? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'quantity'),
            'Required key "DepositWithdrawGoldSchema[quantity]" is missing from JSON.');
        assert(json[r'quantity'] != null,
            'Required key "DepositWithdrawGoldSchema[quantity]" has a null value in JSON.');
        return true;
      }());
  ...
  static List<DepositWithdrawGoldSchema> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = DepositWithdrawGoldSchema.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, DepositWithdrawGoldSchema> mapFromJson(dynamic json) {
    final map = <String, DepositWithdrawGoldSchema>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = DepositWithdrawGoldSchema.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
