    ...
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'type'),
            'Required key "GemTransactionSchema[type]" is missing from JSON.');
        assert(json[r'type'] != null,
            'Required key "GemTransactionSchema[type]" has a null value in JSON.');
        assert(json.containsKey(r'gems'),
            'Required key "GemTransactionSchema[gems]" is missing from JSON.');
        assert(json[r'gems'] != null,
            'Required key "GemTransactionSchema[gems]" has a null value in JSON.');
        assert(json.containsKey(r'description'),
            'Required key "GemTransactionSchema[description]" is missing from JSON.');
        assert(json[r'description'] != null,
            'Required key "GemTransactionSchema[description]" has a null value in JSON.');
        assert(json.containsKey(r'metadata'),
            'Required key "GemTransactionSchema[metadata]" is missing from JSON.');
        assert(json[r'metadata'] != null,
            'Required key "GemTransactionSchema[metadata]" has a null value in JSON.');
        assert(json.containsKey(r'created_at'),
            'Required key "GemTransactionSchema[created_at]" is missing from JSON.');
        assert(json[r'created_at'] != null,
            'Required key "GemTransactionSchema[created_at]" has a null value in JSON.');
        return true;
      }());
