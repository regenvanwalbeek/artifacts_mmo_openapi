...
class BankGoldTransactionSchema {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is BankGoldTransactionSchema &&
  ...
  @override
  String toString() => 'BankGoldTransactionSchema[cooldown=$cooldown, bank=$bank, character=$character]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "BankGoldTransactionSchema[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "BankGoldTransactionSchema[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<BankGoldTransactionSchema> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<BankGoldTransactionSchema>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<BankGoldTransactionSchema>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = BankGoldTransactionSchema.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
