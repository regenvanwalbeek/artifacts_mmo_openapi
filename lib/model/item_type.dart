...
class ItemTypeTypeTransformer {
  ...
  ItemType? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'utility': return ItemType.utility;
        case r'body_armor': return ItemType.bodyArmor;
        case r'weapon': return ItemType.weapon;
        case r'resource': return ItemType.resource;
        case r'leg_armor': return ItemType.legArmor;
        case r'helmet': return ItemType.helmet;
        case r'boots': return ItemType.boots;
        case r'shield': return ItemType.shield;
        case r'amulet': return ItemType.amulet;
        case r'ring': return ItemType.ring;
        case r'artifact': return ItemType.artifact;
        case r'currency': return ItemType.currency;
        case r'consumable': return ItemType.consumable;
        default:
          if (!allowNull) {
