...
class BankExtensionTransactionResponseSchema {
  /// Returns a new [BankExtensionTransactionResponseSchema] instance.
  ...
  /// Returns a new [BankExtensionTransactionResponseSchema] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static BankExtensionTransactionResponseSchema? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return BankExtensionTransactionResponseSchema(
        data: BankExtensionTransactionSchema.fromJson(json[r'data'])!,
      );
    }
    return null;
  }
  ...
  static List<BankExtensionTransactionResponseSchema> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = BankExtensionTransactionResponseSchema.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
