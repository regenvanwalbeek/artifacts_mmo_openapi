...
class ResourceResponseSchema {
  ...
  bool operator ==(Object other) =>
      ...
      other is ResourceResponseSchema && other.data == data;
    ...
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'data'),
            'Required key "ResourceResponseSchema[data]" is missing from JSON.');
        assert(json[r'data'] != null,
            'Required key "ResourceResponseSchema[data]" has a null value in JSON.');
        return true;
      }());
  ...
  static List<ResourceResponseSchema> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<ResourceResponseSchema>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = ResourceResponseSchema.listFromJson(
          entry.value,
          growable: growable,
        );
      }
