    ...
    if (value is Map) {
      ...
      assert(() {
        ...
        assert(json.containsKey(r'total'),
            'Required key "StaticDataPageBadgeSchema[total]" is missing from JSON.');
        assert(json[r'total'] != null,
            'Required key "StaticDataPageBadgeSchema[total]" has a null value in JSON.');
        assert(json.containsKey(r'page'),
            'Required key "StaticDataPageBadgeSchema[page]" is missing from JSON.');
        assert(json[r'page'] != null,
            'Required key "StaticDataPageBadgeSchema[page]" has a null value in JSON.');
        assert(json.containsKey(r'size'),
            'Required key "StaticDataPageBadgeSchema[size]" is missing from JSON.');
        assert(json[r'size'] != null,
            'Required key "StaticDataPageBadgeSchema[size]" has a null value in JSON.');
        assert(json.containsKey(r'pages'),
            'Required key "StaticDataPageBadgeSchema[pages]" is missing from JSON.');
        assert(json[r'pages'] != null,
            'Required key "StaticDataPageBadgeSchema[pages]" has a null value in JSON.');
        return true;
      }());
