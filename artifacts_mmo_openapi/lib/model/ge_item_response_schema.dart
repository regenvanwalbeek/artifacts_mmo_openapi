...
class GEItemResponseSchema {
  ...
  bool operator ==(Object other) =>
      ...
      other is GEItemResponseSchema && other.data == data;
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "GEItemResponseSchema[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "GEItemResponseSchema[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<GEItemResponseSchema> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<GEItemResponseSchema>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = GEItemResponseSchema.listFromJson(
          entry.value,
          growable: growable,
        );
      }
