...
class DataPageCharacterSchema {
  /// Returns a new [DataPageCharacterSchema] instance.
  ...
  /// Returns a new [DataPageCharacterSchema] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static DataPageCharacterSchema? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<DataPageCharacterSchema> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = DataPageCharacterSchema.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, DataPageCharacterSchema> mapFromJson(dynamic json) {
    final map = <String, DataPageCharacterSchema>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = DataPageCharacterSchema.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
