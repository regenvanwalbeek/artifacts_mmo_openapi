...
class DataPageMonsterSchema {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is DataPageMonsterSchema &&
  ...
  @override
  String toString() => 'DataPageMonsterSchema[data=$data, total=$total, page=$page, size=$size, pages=$pages]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "DataPageMonsterSchema[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "DataPageMonsterSchema[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<DataPageMonsterSchema> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<DataPageMonsterSchema>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<DataPageMonsterSchema>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = DataPageMonsterSchema.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
